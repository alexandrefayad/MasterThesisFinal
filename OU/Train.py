...
params = f'{npaths}_{ModelSeed}_{sigma}_{P}'
if long :
    folder = f'LongPaths/{folder}'
...
# g = open(f'LongPathsOU/LRLONG2/lr_{SetSeed}_{sigma}_{npaths}.txt', 'a')
# g.write(f'lr = {lr}, val loss = {Val_loss[-1]} \n')
# g.close()
